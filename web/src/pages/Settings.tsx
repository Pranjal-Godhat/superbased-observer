...
const SECTIONS: SectionDef[] = [
  ...
  },
  {
    ...
    about: {
      summary:
        "Generalized observability — the OTLP /v1/traces receiver, trajectory capture, and the eval plane behind Monitor → Trajectories / Evals. Opt-in and node-local; trace data never leaves this machine.",
      whenModified:
      ...
      behavior:
        "Restart required — the OTLP receiver and obs_* schema bind at `observer start`. Saves write config.toml + .bak.",
    },
  },
  {
    id: "secrets",
